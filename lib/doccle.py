"""
    File name: doccle.py
    Original Author: Steve Gilissen
    Modified by : zdaar
...
class Connector:
    ...
    def download_document(self, file_url):
        ...
        try:
            ...
            warnings.warn(
                f"An error occurred while downloading the document: {err}")
            return None
    ...
    def archive_document(self, doc):
        ...
        for action in doc.get('actions', []):
            ...
            if action_label == "ARCHIVE" and action_method == "PUT":
                ...
                print(
                    f"Archive request response status: {response.status_code}")
                ...
                if response.status_code in [200, 204]:
                    ...
                    print(
                        f"Failed to archive document {doc['name']}: {response.text}")
                    return
